...
# 2 атрибута экземпляра: goals и assists — общее количество голов и передач игрока, изначально оба значения должны
# быть 0;
#
# Метод score, который принимает количество голов, забитых игроком. По умолчанию данное значение равно единице. Метод
# должен увеличивать общее количество забитых голов игрока на переданное значение;
#
# Метод make_assist, который принимает количество передач, сделанных игроком за матч. По умолчанию данное значение
# равно единице. Метод должен увеличивать общее количество сделанных передач игроком на переданное значение;
#
